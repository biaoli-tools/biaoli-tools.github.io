...
- [ ] 隐私、条款和开源许可页面可访问
- [ ] GA4 实时报告能收到测试访问，且隐私政策与当前统计配置一致
...
- 已配置 Google Analytics 4（`G-3ERPJ3X77R`）；统计代码不得发送文件名、表头或单元格内容。
- 首页和五个工具页展示虎跃加速推广横幅，落地页为 `https://huyuejsq.co/`；横幅必须保留“推广”标识和 `rel="sponsored"`。
